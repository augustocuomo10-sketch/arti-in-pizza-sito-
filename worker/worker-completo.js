...
const CATALOGO = {
 ...
 "classiche-salame-e-patate": {
  "nome": "Salame e Patate",
  "categoria": "classiche",
  "prezzi": {
   "Classica": 10.0,
   "Ruota": 28.0
 ...
 "classiche-salsiccia-e-patate": {
  "nome": "Salsiccia e Patate",
  "categoria": "classiche",
  "prezzi": {
   "Classica": 10.0,
   "Ruota": 28.0
 ...
 "classiche-wurstel-e-patate": {
  "nome": "Wurstel e Patate",
  "categoria": "classiche",
  "prezzi": {
   "Classica": 10.0,
   "Ruota": 28.0
 ...
 "classiche-speck-e-gorgonzola": {
  "nome": "Speck e Gorgonzola",
  "categoria": "classiche",
  "prezzi": {
   "Classica": 10.0,
   "Ruota": 28.0
 ...
 "classiche-pere-zola-e-noci": {
  "nome": "Pere, Zola e Noci",
  "categoria": "classiche",
  "prezzi": {
   "Classica": 12.0,
   "Ruota": 30.0
 ...
 "classiche-friarielli-e-salsiccia": {
  "nome": "Friarielli e Salsiccia",
  "categoria": "classiche",
  "prezzi": {
   "Classica": 12.0,
   "Ruota": 30.0
 ...
 "paste-pasta-bella-donna": {
  "nome": "Pasta Bella Donna",
  "categoria": "paste",
  "prezzi": {
   "unico": 9.0
  }
 },
 "paste-pasta-e-patate": {
  "nome": "Pasta e Patate",
  "categoria": "paste",
  "prezzi": {
   "unico": 9.0
 ...
 "panuozzi-friarielli-e-salsiccia": {
  "nome": "Friarielli e Salsiccia",
  "categoria": "panuozzi",
  "prezzi": {
   "unico": 7.5
 ...
 "dolci-calzone-alla-nutella": {
  "nome": "Calzone alla Nutella",
  "categoria": "dolci",
  "prezzi": {
   "unico": 4.0
  }
...
function problemaTelefono(grezzo) {
...
// ---------------------------------------------------------------- totali
function calcolaTotale(righe, modalita) {
...
// ------------------------------------------------------------- verifica
async function verificaZonaConsegna(indirizzo, env) {
